...
const CONTENT_HELPER_GLOBALS = [
    ...
    'NSM_CREATE_CONTENT_SNAPSHOT_SIGNATURE',
    'NSM_CREATE_CONTENT_STATE_REPAIR',
    ...
    'NSM_CREATE_CONTENT_SEARCH_SEMANTICS',
    'NSM_CREATE_CONTENT_RENDER',
    'NSM_CREATE_CONTENT_VIEW_STATE',
    'NSM_CREATE_CONTENT_NATIVE_CHECKBOX_SYNC',
    'NSM_CREATE_CONTENT_DRAG_MULTI',
    'NSM_CREATE_CONTENT_DRAG_REFLOW',
    'NSM_CREATE_CONTENT_TREE_INTERACTIONS',
    'NSM_CREATE_CONTENT_NATIVE_LABEL_DETECTOR',
