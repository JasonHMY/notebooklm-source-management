...
function getRequiredMessageKeys() {
    return [
        ...
        'ui_whats_new_batch_drag_title',
        'ui_whats_new_batch_drag_body',
        'ui_whats_new_hover_expand_title',
        'ui_whats_new_hover_expand_body',
        'ui_whats_new_smart_feedback_title',
        'ui_whats_new_smart_feedback_body',
