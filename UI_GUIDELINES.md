...
- `.dragging`, `.sp-drag-folded`, `.sp-drag-unfolding`, `.sp-drop-shift`, `.drag-into`, `.drag-invalid`, `.sp-pseudo-hover`, `.sp-drag-active`, `.sp-drag-guide` styles all live in `contentStyleText` (Shadow DOM scope).
