...
- `.dragging`, `.sp-drag-folded`, `.sp-drag-unfolding`, `.sp-drop-shift`, `.sp-drop-landing`, `.sp-drop-flying`, `.sp-drop-landed`, `.drag-into`, `.drag-invalid`, `.sp-pseudo-hover`, `.sp-drag-active` styles all live in `contentStyleText` (Shadow DOM scope).
